...
### [Configurer Skype Entreprise](https://docs.microsoft.com/skypeforbusiness/manage/authentication/use-adal)
...
#### [Connecter un réseau local à Azure Virtual Network](connect-an-on-premises-network-to-a-microsoft-azure-virtual-network.md)
#### [Déployer un serveur de synchronisation de répertoire dans Azure IaaS](deploy-office-365-directory-synchronization-dirsync-in-microsoft-azure.md)
