...
### [Éléments courants de connectivité du cloud Microsoft](common-elements-of-microsoft-cloud-connectivity.md)
...
### [Scénarios de cloud hybride pour Microsoft SaaS (Office 365)](hybrid-cloud-scenarios-for-microsoft-saas-office-365.md)
### [Scénarios de cloud hybride pour Azure PaaS](hybrid-cloud-scenarios-for-azure-paas.md)
### [Scénarios de cloud hybride pour Azure IaaS](hybrid-cloud-scenarios-for-azure-iaas.md)
## [Abonnements, licences, comptes et clients des offres de cloud de Microsoft](subscriptions-licenses-accounts-and-tenants-for-microsoft-cloud-offerings.md)
...
# [Plan pour Office 365](get-your-organization-ready-for-office-365.md)
...
### [Planification du réseau et de la migration pour Office 365](network-and-migration-planning.md)
...
### [Applications intégrées et Azure AD pour les administrateurs d’Office 365](integrated-apps-and-azure-ads.md)
## [Intégration d’Office 365](office-365-integration.md)
### [Intégration d’Azure à Office 365](azure-integration.md)
...
### [Collaboration entre clients dans Office 365](office-365-inter-tenant-collaboration.md)
...
## [Mettre à niveau votre version d’Office](plan-upgrade-previous-versions-office.md)
...
### [eDiscovery avancée](advanced-ediscovery-for-your-office-365-dev-test-environment.md)
...
## [Configurer votre réseau](set-up-network-for-office-365.md)
...
### [URL et adresses IP Office 365](office-365-endpoints.md)
...
#### [Planification du réseau avec ExpressRoute pour Office 365](network-planning-with-expressroute.md)
#### [Routage avec ExpressRoute pour Office 365](routing-with-expressroute.md)
## Configurer votre abonnement
### [Préparer l’attribution des utilisateurs via la synchronisation d’annuaires dans Office 365](prepare-for-directory-synchronization.md)
...
### [Migrer des données vers Office 365](migrate-data-to-office-365.md)
...
## [Office 365 multigéographique](office-365-multi-geo.md)
...
#### [Circonscrire le contenu à un emplacement géographique](restrict-content-to-geo-location.md)
#### [Configurer l’eDiscovery d’Office 365 multigéographique](multi-geo-ediscovery-configuration.md)
...
#### [Authentification fédérée haute disponibilité, phase 5 : Configurer l'authentification fédérée pour Office 365](high-availability-federated-authentication-phase-5-configure-federated-authentic.md)

# Gérer Office 365
## [État du service](view-service-health.md)
### [Surveiller la connectivité](monitor-connectivity.md)
### [Options de support](https://support.office.com/en-us/article/Contact-support-for-business-products-Admin-Help-32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b)
...
### [Outils permettant de gérer les comptes Office 365](manage-office-365-accounts.md)
### [Ajouter plusieurs utilisateurs simultanément à Office 365 - Aide de l’administrateur](add-several-users-at-the-same-time.md)
...
### [Optimisation des performances d’Office 365 à l’aide de lignes de référence et de l’historique des performances](performance-tuning-using-baselines-and-history.md)
...
### [Consulter l’état de synchronisation des annuaires dans Office 365](view-directory-synchronization-status.md)
### [Identifier les erreurs de synchronisation d’annuaires dans Office 365](identify-directory-synchronization-errors.md)
### [Résolution des problèmes de synchronisation d’annuaires pour Office 365](fix-problems-with-directory-synchronization.md)
