...
# Diagramme accessible - SharePoint Server, Exchange, Lync, Office Web Apps : panorama des solutions mobiles

Cet article est une version texte accessible du diagramme intitulé Options de plateforme Microsoft Exchange 2013, qui est disponible dans la rubrique [Diagrammes techniques](http://go.microsoft.com/fwlink/?LinkID=519139).
...
## Applications et expériences basées sur le navigateur
...
### Gestion des appareils et distribution des logiciels
...
## Déploiements mobiles dans le cloud et locaux
