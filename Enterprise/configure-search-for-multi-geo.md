...
<p>Figure 1 : Recherche dans un locataire avec trois emplacements geo</p></th>
<th align="left"><p>Client de recherche appelle le point de terminaison de recherche reste avec la propriété de requête EnableMultiGeoSearch = true.</p>
<p>La requête est envoyée à tous les emplacements de geo dans le locataire.</p>
<p>Résultats de la recherche à partir de chaque emplacement géographique sont fusionnées et classés.</p>
<p>Le client obtient des résultats de la recherche unifiée.</p></th>
</tr>
</thead>
<tbody>
</tbody>
...
### Obtenir un centre de recherche pour afficher les résultats de tous les emplacements de la zone géographique
...
3.  Sélectionnez vertical pour définir, cliquez sur icône engrenage de **paramètres** dans l’angle supérieur droit, puis cliquez sur **Modifier la Page**.

> ![](media/configure-search-for-multi-geo_image2.png)
>
> La page de résultats de recherche s’ouvre en mode édition.

1.  Dans le composant WebPart résultats de recherche, déplacez le pointeur vers le haut, à droite du composant WebPart, cliquez sur la flèche et puis cliquez sur **Modifier des composants WebPart** dans le menu. ![](media/configure-search-for-multi-geo_image3.png)

> Le volet d’outils composant WebPart résultats de la recherche s’affiche sous le ruban dans la partie supérieure droite de la page.
...
<td align="left">La requête n’était pas une requête Multi-Geo et ne était pas serveur à l’autre emplacement géographique.</td>
</tr>
</tbody>
</table>
