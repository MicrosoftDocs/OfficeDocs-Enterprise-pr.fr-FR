...
2. **Microsoft Azure :** Créez un réseau virtuel Azure avec une connexion VPN de site à site. Cet article ne décrit pas l’utilisation de [ExpressRoute](https://azure.microsoft.com/services/expressroute/).
