...
1. Dans Internet Explorer ou votre navigateur, accédez à [https://admin.microsoft.com](https://admin.microsoft.com) et connectez-vous à l’aide de votre compte d’administrateur général Office 365.
    
2. Dans l’onglet **Accueil Microsoft Office** , cliquez sur la vignette **administrateur** .
    
3. Dans l’onglet Office 365 admin, dans le volet de navigation de gauche, cliquez sur **facturation > acheter des services**.
...
1. Utilisez votre navigateur et accédez au [portail Azure](https://portal.azure.com).
    
2. Cliquez sur **groupes de ressources >** [nom de votre groupe de ressources] **> CLIENT1 > connecter**.
    
3. À partir de CLIENT1, exécutez Internet Explorer, accédez au portail Office [https://admin.microsoft.com](https://admin.microsoft.com)à, puis connectez-vous avec le nom de compte utilisateur 5 et le mot de passe.
...
2. Accédez à [https://admin.microsoft.com](https://admin.microsoft.com).
    
3. Sur la page **de connexion à Office 365** , cliquez sur le nom de compte utilisateur 5 et connectez-vous.
    
4. Dans l’onglet **Accueil Microsoft Office** , cliquez sur **SharePoint > support collection de sites**.
...
[Environnement de développement/test Office 365 et EMS](https://technet.microsoft.com/library/c76eea86-d4b6-4d35-ad89-341696e89ef7.aspx)
