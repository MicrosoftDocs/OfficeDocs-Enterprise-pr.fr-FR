...
# Déployer la synchronisation d'annuaires (DirSync) Office 365 dans Microsoft Azure
...
- [Vue d'ensemble du déploiement de la synchronisation d'annuaires Office 365 dans Azure](deploy-office-365-directory-synchronization-dirsync-in-microsoft-azure.md#Overview)
    
- [Planification de l'hébergement d'un serveur DirSync pour Office 365 dans Azure](deploy-office-365-directory-synchronization-dirsync-in-microsoft-azure.md#PlanningVirtual)
    
- Feuille de route de déploiement
    
> [!IMPORTANT]
> Cette solution exige une connectivité entre votre réseau local et votre réseau virtuel Azure. Pour plus d'informations, voir [Connecter un réseau local à Microsoft Azure Virtual Network](81190961-5454-4a5c-8b0e-6ae75b9fb035.md).
...
1. La création d'un réseau virtuel Azure et l'établissement d'une connexion VPN de site à site vers votre réseau local. Pour plus d'informations, voir [Connecter un réseau local à Microsoft Azure Virtual Network](81190961-5454-4a5c-8b0e-6ae75b9fb035.md).
...
1. Création d'un Ordinateur virtuel Azure pour exécuter Azure AD Connect.
    
2. Installation et configuration d'[Azure AD Connect](https://www.microsoft.com/download/details.aspx?id=47594).
...
## Planification de l'hébergement d'un serveur DirSync pour Office 365 dans Azure
...
- Examinez le contenu de planification associé dans [Planification de votre réseau Azure Virtual Network](81190961-5454-4a5c-8b0e-6ae75b9fb035.md#PlanningVirtual).
    
- Veillez à respecter toutes les [conditions préalables](http://technet.microsoft.com/library/81190961-5454-4a5c-8b0e-6ae75b9fb035%28v=office.15%29.aspx#Prerequisites) pour la configuration du réseau virtuel Azure.
...
Pour créer et configurer le réseau virtuel Azure, effectuez la [phase 1 en préparant votre réseau local](http://technet.microsoft.com/library/81190961-5454-4a5c-8b0e-6ae75b9fb035%28v=office.15%29.aspx#Phase1) et la[phase 2 en créant le réseau virtuel entre différents locaux dans Azure](http://technet.microsoft.com/library/81190961-5454-4a5c-8b0e-6ae75b9fb035%28v=office.15%29.aspx#Phase2) décrites dans la feuille de route de déploiement de l'article[Connecter un réseau local à Microsoft Azure Virtual Network](81190961-5454-4a5c-8b0e-6ae75b9fb035.md).
...
[Connecter un réseau local à Microsoft Azure Virtual Network](81190961-5454-4a5c-8b0e-6ae75b9fb035.md)
#### 
