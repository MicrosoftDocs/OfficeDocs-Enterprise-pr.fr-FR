...
Pour créer et configurer le réseau virtuel Azure, Terminer [Phase 1 : préparation de votre réseau local](connect-an-on-premises-network-to-a-microsoft-azure-virtual-network.md#Phase1) et [Phase 2 : créer le réseau virtuel de coexistence dans Azure](connect-an-on-premises-network-to-a-microsoft-azure-virtual-network.md#Phase2) du déploiement feuille de route des [se connecter à un réseau local à un Réseau virtuel de Microsoft Azure](connect-an-on-premises-network-to-a-microsoft-azure-virtual-network.md).
