...
---
# <a name="deployment-planning-checklist-for-microsoft-365"></a>Liste de vérification de la planification du déploiement pour Microsoft 365

Lorsque vous déplacez une organisation d’entreprise vers Microsoft 365, il est important de planifier exactement les étapes à suivre, le moment de leur exécution et les personnes qui les exécuteront. Cette liste de contrôle permet à votre organisation de planifier et de préparer une migration vers Microsoft 365. N’hésitez pas à adapter cette liste de contrôle aux besoins de votre organisation.

## <a name="need-help-with-your-deployment"></a>Vous avez besoin d’aide pour votre déploiement ?
Souhaitez-vous obtenir de l’aide pour la configuration de Microsoft 365 ? Envisagez d’utiliser [FastTrack](https://fasttrack.microsoft.com/microsoft-365) ou les [guides de configuration pour les services Microsoft 365](setup-guides-for-office-365.md).

## <a name="sample-checklist-for-a-microsoft-365-enterprise-deployment"></a>Exemple de liste de vérification pour un déploiement Microsoft 365 Enterprise
...
| Collecter les systèmes de messagerie instantanée et de réunion en ligne que vous envisagez de migrer |||||
...
| Comment les comptes d’utilisateur seront-ils [authentifiés](https://go.microsoft.com/fwlink/?LinkId=534820)? |||||
...
| Préparer vos données pour une migration ( [courrier électronique](https://go.microsoft.com/fwlink/?LinkId=534823) et [fichiers](https://go.microsoft.com/fwlink/?LinkId=534824)) |||||
...
|**Configurer les services Microsoft 365 pour qu’ils fonctionnent pour votre organisation** |||||
|Configurer votre abonnement Microsoft 365 |||||
...
|Configurer des comptes et des boîtes aux lettres |||||
| Ajouter vos utilisateurs et [attribuer des licences aux utilisateurs dans Microsoft 365 pour les entreprises](https://support.office.com/article/997596b5-4173-4627-b915-36abac6786dc) |||||
| Migrer les données ( [courrier électronique](https://go.microsoft.com/fwlink/?LinkId=534823)et [fichiers](https://go.microsoft.com/fwlink/?LinkId=534824), etc.) (facultatif) |||||
|Valider la fonctionnalité, puis effectuer les étapes finales |||||
| Migrez les [paramètres DNS vers Microsoft 365](https://go.microsoft.com/fwlink/?LinkId=534835) |||||
| Indiquer à vos utilisateurs quand ils peuvent [commencer à utiliser Microsoft 365](https://support.office.com/article/office-365-basics-video-training-396b8d9e-e118-42d0-8a0d-87d1f2f055fb?ui=en-US&amp;rs=en-US&amp;ad=US) |||||
| Reconfigurer les systèmes clients pour se connecter à Microsoft 365 ( [Office](https://go.microsoft.com/fwlink/?LinkId=534836), [Outlook](https://go.microsoft.com/fwlink/?LinkId=534837), [Outlook pour Mac](https://support.office.com/article/6e27792a-9267-4aa4-8bb6-c84ef146101b#PickTab=Outlook_for_Mac), [appareils mobiles](https://go.microsoft.com/fwlink/?LinkId=534840))  |||||
