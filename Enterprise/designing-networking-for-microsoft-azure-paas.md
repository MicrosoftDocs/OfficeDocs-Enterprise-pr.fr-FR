...
2. Optimiser la bande passante Internet à l’aide des étapes 2 à 4 de la section **d’étapes à suivre pour préparer votre réseau pour les services Microsoft SaaS** dans la [conception de mise en réseau pour Microsoft SaaS](designing-networking-for-microsoft-saas.md).
...
Pour plus d’informations, consultez [Gestionnaire de trafic](https://docs.microsoft.com/azure/traffic-manager/traffic-manager-overview).
