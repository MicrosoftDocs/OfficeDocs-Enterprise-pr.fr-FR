...
### <a name="run-problem-steps-recorder-psrexe-to-record-your-work"></a>Exécuter l’enregistreur d’étapes du problème (V.Q.P.R.D.. exe) pour enregistrer votre travail
