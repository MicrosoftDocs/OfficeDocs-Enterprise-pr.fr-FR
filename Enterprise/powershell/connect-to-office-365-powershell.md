...
Commandes dans la Microsoft Azure Active Directory Module pour Windows PowerShell ont **Msol** dans leur nom de l’applet de commande.
...
2. Installer le le Microsoft Azure Active Directory Module pour Windows PowerShell avec ces étapes :
    
  - Ouvrez une invite de commandes de PowerShell de niveau administrateur.
  - Exécutez la commande **MSOnline du Module d’installation** .
  - Si vous êtes invité à installer le fournisseur de NuGet, tapez **o** et appuyez sur ENTRÉE.
...
1. Exécuter à une invite de commande Windows PowerShell.
...
3. Dans la boîte de dialogue **Demande d’informations d’identification Windows PowerShell** , tapez votre travail d’Office 365 ou le nom de l’école compte utilisateur et le mot de passe, puis cliquez sur **OK**.
...
3. Dans la boîte de dialogue **Azure Active Directory PowerShell** , tapez votre travail d’Office 365 ou le nom de l’école compte utilisateur et le mot de passe, puis cliquez sur **se connecter**.
...
Pour vous connecter à votre abonnement à Office 365 avec *une authentification multifacteur (AMF)*:
