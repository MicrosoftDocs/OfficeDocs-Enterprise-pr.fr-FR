...
Vous devrez peut-être ajouter un autre suffixe UPN pour associer les informations d'identification d'entreprise de l'utilisateur à l'environnement Office 365. Un suffixe UPN est la partie d'un UPN à droite du caractère @. Les UPN utilisés pour l'authentification unique peuvent contenir des lettres, des chiffres, des points, des tirets et des traits de soulignement, mais pas d'autres types de caractères.
