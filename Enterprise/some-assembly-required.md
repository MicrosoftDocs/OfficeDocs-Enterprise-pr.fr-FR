...
- Utilisez les services existants comme point de départ pour votre solution de stockage.
    
- Nécessitent une configuration ou le codage.
    
- Peut être personnalisé pour répondre à vos besoins.
    
Les sections suivantes décrivent les détails de chaque solution de stockage de « Certains assembly requis ».
