 ...
 **Résumé :** Apprenez à créer un atelier de test intégré qui contient un serveur qui exécute Exchange Server 2013, un serveur qui exécute Microsoft Lync Server 2013 et un serveur qui exécute SharePoint Server 2013.
